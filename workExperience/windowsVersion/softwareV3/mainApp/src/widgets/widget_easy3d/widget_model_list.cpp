...
public:
    ...
    void setIcon(int column) {
        if (dynamic_cast<SurfaceMesh*>(model())) {
            static QIcon iconMesh(QString::fromUtf8(":/icons/icons/mesh.png"));
            QTreeWidgetItem::setIcon(column, iconMesh);
        }
        else if (dynamic_cast<PointCloud*>(model())) {
            static QIcon iconPointCloud(QString::fromUtf8(":/icons/icons/point_cloud.png"));
            QTreeWidgetItem::setIcon(column, iconPointCloud);
        }
        else if (dynamic_cast<Graph*>(model())) {
            static QIcon iconGraph(QString::fromUtf8(":/icons/icons/graph.png"));
            QTreeWidgetItem::setIcon(column, iconGraph);
        }
        else if (dynamic_cast<PolyMesh*>(model())) {
            static QIcon iconTetrahedra(QString::fromUtf8(":/icons/icons/tetrahedra.png"));
    ...
    void setVisible(int column, bool visible) {
        static QIcon iconShow(QString::fromUtf8(":/icons/icons/show.png"));
        static QIcon iconHide(QString::fromUtf8(":/icons/icons/hide.png"));
        if (visible)
    ...
    void highlight(bool b) {
        for (int i = 0; i < columnCount(); ++i)
            QTreeWidgetItem::setBackground(i, b ? QColor(43, 43, 43, 220) : QBrush());
    }
...
void WidgetModelList::init(mainApp* w) {
    mainWindow_ = w;
