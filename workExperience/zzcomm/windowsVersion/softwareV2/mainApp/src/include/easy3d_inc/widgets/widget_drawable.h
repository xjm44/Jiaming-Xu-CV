...
public:
    ...
    void setActiveDrawable(easy3d::Drawable* d); // set drawable


public slots:

    void setDrawableVisible(bool b); // show/hide
    void setLighting(const QString& text); // lightning

    virtual void setColorScheme(const QString& text); // color choice

    void setDistinctBackColor(bool);

    virtual void setScalarFieldStyle(int); // intensity
    void setScalarFieldDiscreteColors(bool);
    void setScalarFieldNumOfStripes(int);
    void setScalarFieldClamp(bool);         // clamp %
    ...
    void setVectorFieldScale(double); // normal
