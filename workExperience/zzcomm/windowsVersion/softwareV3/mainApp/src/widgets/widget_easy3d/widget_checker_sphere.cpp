...
#include "../../include/include_easy3d/widgets/widget_checker_sphere.h"
...
void WidgetCheckerSphere::setBackgroundColor(const QColor& c) {
...
void WidgetCheckerSphere::createSpheres() {
    ...
    normals.clear();
    colors.clear();
    shape::create_sphere(vec3(0, 0, 0), 0.12, 10, 10, vec3(1, 0, 0), vertices, normals, colors);
