...
#include "../../include/include_easy3d/tools/tool_selection_point_cloud.h"
        ...
        void ToolPointCloudSelection::update_render_buffer(PointCloud* cloud) const {
            ...
            if (pointClick) {
                if ((d->coloring_method() != easy3d::State::SCALAR_FIELD) || (d->property_location() != State::VERTEX) || (d->property_name() != "v:selectPoint")) {
                    ...
                    //if (cloud->get_vertex_property<bool>("v:intensity"))
                        //d->set_coloring(State::SCALAR_FIELD, State::VERTEX, "v:intensity");
                    //else
